...
parser.add_argument('--masks_dir', type=str, default='masks', help='Directory to store extracted JSON mask files.')
parser.add_argument('--skip_existing', action='store_true', help='Skip extraction if the file has already been extracted')
parser.add_argument('--num_files', type=int, default=1000, help='Number of data shards to download. Default is 1000, i.e. the whole dataset.')
...
# Select the first num_files shards to download
lines = lines[:args.num_files]
print('Lines:', lines)    
